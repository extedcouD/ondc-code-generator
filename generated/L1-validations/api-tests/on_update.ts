                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_26**: $.message.order.fulfillments[*].vehicle.registration must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_29**: $.message.order.fulfillments[*].agent.person.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_30**: $.message.order.fulfillments[*].agent.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_45**: $.message.order.cancellation_terms[*].fulfillment_state.descriptor.code must be present in the payload`,
                        },
                    ];
                }
