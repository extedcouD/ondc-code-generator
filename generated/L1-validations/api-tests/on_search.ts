                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_16**: $.message.catalog.providers[*].fulfillments[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_19**: $.message.catalog.providers[*].fulfillments[*].stops[*].location.gps must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_21**: $.message.catalog.providers[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_23**: $.message.catalog.providers[*].descriptor.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_24**: $.message.catalog.providers[*].items[*].price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_25**: $.message.catalog.providers[*].items[*].price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_26**: $.message.catalog.providers[*].items[*].fulfillment_ids[*] must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_7**: every element of $.message.catalog.providers[*].fulfillments[*].vehicle.variant must be in ["SEDAN", "SUV", "HATCHBACK", "TWO_WHEELER", "AUTO_RICKSHAW"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_8**: every element of $.message.catalog.providers[*].fulfillments[*].vehicle.energy_type must be in ["ELECTRIC", "PETRO", "DIESEL", "HYDROGEN", "BIOFUELS", "CNG", "LPG"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_10**: every element of $.message.catalog.providers[*].fulfillments[*].type must be in ["START", "END"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_11**: every element of $.message.catalog.providers[*].fulfillments[*].stops[*].authorization.type must be in ["OTP", "QR"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_12**: every element of $.message.catalog.providers[*].fulfillments[*].stops[*].authorization.status must be in ["UNCLAIMED", "CLAIMED"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_13**: every element of $.message.catalog.providers[*].fulfillments[*].state.descriptor.code must be in ["RIDE_CANCELLED", "RIDE_ENDED", "RIDE_STARTED", "RIDE_ASSIGNED", "RIDE_ENROUTE_PICKUP", "RIDE_ARRIVED_PICKUP", "RIDE_CONFIRMED"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_16**: every element of $.message.catalog.providers[*].payments[*].type must be in ["PRE-ORDER", "ON-ORDER", "ON-FULFILLMENT"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_0**: every element of $.message.catalog.providers[*].items[*].tags[*].descriptor.code must be in ["FARE_POLICY", "INFO"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_0_FARE_POLICY**: every element of $.message.catalog.providers[*].items[*].tags[?(@.descriptor.code=='FARE_POLICY')].list[*].descriptor.code must be in ["MIN_FARE", "MIN_FARE_DISTANCE_KM", "PER_KM_CHARGE", "PICKUP_CHARGE", "WAITING_CHARGE_PER_MIN", "NIGHT_CHARGE_MULTIPLIER", "NIGHT_SHIFT_START_TIME", "NIGHT_SHIFT_END_TIME"]`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_0_INFO**: every element of $.message.catalog.providers[*].items[*].tags[?(@.descriptor.code=='INFO')].list[*].descriptor.code must be in ["DISTANCE_TO_NEAREST_DRIVER_METER", "ETA_TO_NEAREST_DRIVER_MIN"]`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_1**: every element of $.message.catalog.providers[*].payments[*].tags[*].descriptor.code must be in ["BUYER_FINDER_FEES", "SETTLEMENT_TERMS"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_1_BUYER_FINDER_FEES**: every element of $.message.catalog.providers[*].payments[*].tags[?(@.descriptor.code=='BUYER_FINDER_FEES')].list[*].descriptor.code must be in ["BUYER_FINDER_FEES_TYPE", "BUYER_FINDER_FEES_PERCENTAGE", "BUYER_FINDER_FEES_AMOUNT"]`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_tag_1_SETTLEMENT_TERMS**: every element of $.message.catalog.providers[*].payments[*].tags[?(@.descriptor.code=='SETTLEMENT_TERMS')].list[*].descriptor.code must be in ["SETTLEMENT_WINDOW", "SETTLEMENT_BASIS", "SETTLEMENT_TYPE", "MANDATORY_ARBITRATION", "COURT_JURISDICTION", "DELAY_INTEREST", "STATIC_TERMS", "SETTLEMENT_AMOUNT"]`,
                        },
                    ];
                }
