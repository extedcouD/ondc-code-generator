...
export default function on_cancel(input: validationInput): validationOutput {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_17**: $.message.order.items[*].fulfillment_ids[*] must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_18**: $.message.order.items[*].payment_ids[*] must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_24**: $.message.order.fulfillments[*].stops[*].location.gps must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_25**: $.message.order.fulfillments[*].customer.person.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_26**: $.message.order.fulfillments[*].customer.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_27**: $.message.order.fulfillments[*].agent.person.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_28**: $.message.order.fulfillments[*].agent.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_29**: $.message.order.fulfillments[*].vehicle.registration must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_31**: $.message.order.fulfillments[*].vehicle.make must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_32**: $.message.order.fulfillments[*].vehicle.model must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_35**: $.message.order.quote.price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_36**: $.message.order.quote.price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_38**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_39**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_42**: $.message.order.payments[*].params.bank_code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_43**: $.message.order.payments[*].params.bank_account_number must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_46**: $.message.order.cancellation_terms[*].fulfillment_state.descriptor.code must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_47**: $.message.order.cancellation_terms[*].reason_required must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_48**: $.message.order.id must be present in the payload`,
                        },
                    ];
                }
  ...
  - **condition validate_enum_16.2**: $.message.order.payments[*].type must be present in the payload`,
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_17**: every element of $.message.order.cancellation.reason.descriptor.code must be in ["000", "001", "002", "003", "004", "005", "011", "012", "013", "014"]
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_18**: every element of $.message.order.cancellation.cancelled_by must be in ["CONSUMER", "PROVIDER"]
	...
	> - **condition B**: $.message.order.cancellation.cancelled_by must **not** be present in the payload`,
        ...
        function validate_enum_19(input: validationInput): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
            let valid = true;
            for (const testObj of scope) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_19**: all of the following sub conditions must be met:
  ...
  - **condition validate_enum_19.2**: $.message.order.quote.breakup[*].title must be present in the payload`,
        ...
        function validate_enum_20(input: validationInput): validationOutput {
            const scope = payloadUtils.getJsonPath(input.payload, "$");
            let subResults: validationOutput = [];
            let valid = true;
            for (const testObj of scope) {
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_20**: all of the following sub conditions must be met:
