                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_16**: $.message.order.fulfillments[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_18**: $.message.order.fulfillments[*].stops[*].location.gps must be present in the payload`,
                        },
                    ];
                }
