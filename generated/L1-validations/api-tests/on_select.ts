                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_20**: $.message.order.provider.id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_21**: $.message.order.fulfillments[*].id must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_23**: $.message.order.fulfillments[*].stops[*].location.gps must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_25**: $.message.order.quote.price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_26**: $.message.order.quote.price.currency must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_28**: $.message.order.quote.breakup[*].price.value must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_29**: $.message.order.quote.breakup[*].price.currency must be present in the payload`,
                        },
                    ];
                }
