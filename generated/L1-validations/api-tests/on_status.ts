                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_26**: $.message.order.fulfillments[*].customer.person.name must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_attribute_27**: $.message.order.fulfillments[*].customer.contact.phone must be present in the payload`,
                        },
                    ];
                }
                    ...
                    return [
                        {
                            valid: false,
                            code: 30000,
                            description: `- **condition validate_enum_19**: every element of $.message.order.status must be in ["SOFT_CANCEL", "CONFIRM_CANCEL", "ACTIVE", "COMPLETE", "CANCELLED"]
